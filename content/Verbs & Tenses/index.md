...
| Tense                    | English Sentence | Pidgin Equivalent |
| ------------------------ | ---------------- | ----------------- |
| Future Tense             | I will run.      | I go run.         |
| Present continuous tense | I am running.    | I dey run.        |
...
<!--
TODO: On completing sections on conjugation and verbs in general, add references to the pages relevant to the auxiliary verbs used for denoting tense.
-->
